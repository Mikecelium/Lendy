...
class AnimatedRoutePage1 extends StatelessWidget {
  @override
...
class AnnotationClickListener extends OnPointAnnotationClickListener {
  ...
  void onPointAnnotationClick(PointAnnotation annotation) async {
    ...
    final coordinates = await fetchRouteCoordinates(
        start, end.coordinates, 'pk.eyJ1IjoibWlrZW9sc2VuIiwiYSI6ImNsanllbjVybTAzYTczbHFnNGdxc2hoY2kifQ.w1MWWZd8X2Ofk1uKWFqhJA');
